const bakanlikTeskilatiDB = {
    meta: {
        kaynak: "Bakanlık Teşkilatı",
        surum: "v1",
    ...
    maddeler: [
        {
            ...
            tuzaklar: {
                ...
                hap: [
                    "Konu verisi dosyadan geliyor",
                    "Mevzuat alanı aktif",
                    "İçerik daha sonra özelleştirilecek"
                ]
            },
            tarihce: {
                baslik: "Demo Tarihçe",
...
window.bakanlikTeskilatiDB = bakanlikTeskilatiDB;